...
class TeraClientInterfaceServer {
    constructor(isAdmin, host, port, onAccept, onReady, onError) {
        ...
        if (process.platform === 'win32') {
            ...
            this.processListener = new ProcessListenerDLLInjector(isAdmin, 1000);
        } else {
    ...
    accept(socket) {
        ...
        if (this.processListener)
            this.processListener.setInterval(5000);
    }

    onDisconnect(connection) {
        this.connections.delete(connection);
        if (this.processListener)
            this.processListener.setInterval(this.connections.size > 0 ? 5000 : 1000);
    }
}
